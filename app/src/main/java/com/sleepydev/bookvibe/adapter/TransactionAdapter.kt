...
class TransactionAdapter ( fragment: Fragment):  RecyclerView.Adapter<TransactionAdapter.ViewHolder>() {
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): TransactionAdapter.ViewHolder {
        _binding = TransactionAdapterBinding.inflate(LayoutInflater.from(parent.context), parent, false)
    ...
    override fun onBindViewHolder(holder: TransactionAdapter.ViewHolder, position: Int) {
        ...
        val requestOptions = RequestOptions()
            ...
            binding.productName.text =  productData!![position].productName
             Glide.with(fragment).load( productData!![position].adjustedImg).apply(requestOptions).into(binding.productImage)
