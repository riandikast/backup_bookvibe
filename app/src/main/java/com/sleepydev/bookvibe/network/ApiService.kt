...
interface ApiService {
    ...
    @PUT("user/{id}")
    fun updateUser(
        @Body user: UpdateResponse,
        @Path("id") id: Int,
    ): Call<User>

    @PUT("user/{id}")
    fun updateTransaction(
        @Body user: TransactionResponse,
        @Path("id") id: Int,
    ): Call<User>

    @PUT("product/{id}")
    fun updateStock(
        @Body user: UpdateStockResponse,
        @Path("id") id: Int,
    ): Call<Product>

    @PUT("product/{id}")
    fun productSold(
        @Body user: SoldResponse,
        @Path("id") id: Int,
    ): Call<Product>

    @PUT("user/{id}")
    fun topUpBalance(
        @Body user: TopUpResponse,
        @Path("id") id: Int,
    ): Call<User>
